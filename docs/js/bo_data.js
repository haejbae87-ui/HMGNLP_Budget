...
const BO_PERSONAS = {
  ...
  platform_admin: {
    ...
    accessMenus: ['dashboard', 'platform-monitor', 'platform-roles', 'isolation-groups', 'budget-account', 'reports']
  },
  ...
  hmc_tenant_admin: {
    ...
    accessMenus: ['dashboard', 'isolation-groups', 'budget-account', 'reports', 'manual']
  },
  // ── HMC 일반예산 그룹 ────────────────────────────────────────────────────────
  hmc_total_general: {
