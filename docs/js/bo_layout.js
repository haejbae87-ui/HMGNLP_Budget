...
const PLATFORM_MENUS = [
  ...
  { id: 'isolation-groups',  icon: '🛡️', label: '교육지원도메인 관리',      section: null, gnb: GNB_CATE.TENANT },
  // 교육제도 (업무 흐름 순)
  { id: 'virtual-org',       icon: '🏗️', label: '가상조직 템플릿 관리',   section: '제도 설정', gnb: GNB_CATE.PROGRAM },
  { id: 'budget-account',    icon: '💳', label: '예산 계정 관리',          section: null, gnb: GNB_CATE.PROGRAM },
  { id: 'calc-grounds',      icon: '📐', label: '산정기준 관리',          section: null, gnb: GNB_CATE.PROGRAM },
  { id: 'edu-type-mgmt',     icon: '🏷️', label: '교육유형 관리',          section: null, gnb: GNB_CATE.PROGRAM },
  { id: 'form-builder',      icon: '📝', label: '교육양식마법사',          section: null, gnb: GNB_CATE.PROGRAM },
  { id: 'field-mgmt',        icon: '⚙️', label: '입력 필드 관리',          section: null, gnb: GNB_CATE.PROGRAM },
  { id: 'service-policy',    icon: '🔧', label: '서비스 정책 관리',        section: '교육운영', gnb: GNB_CATE.PROGRAM },
  { id: 'plan-mgmt',         icon: '📋', label: '교육계획 관리',           section: null, gnb: GNB_CATE.PROGRAM },
  { id: 'allocation',        icon: '💰', label: '예산 배정 및 관리',       section: null, gnb: GNB_CATE.PROGRAM },
  { id: 'my-operations',     icon: '📥', label: '나의 운영 업무',           section: null, gnb: GNB_CATE.PROGRAM },
  // 통계
...
const TENANT_ADMIN_MENUS = [
  ...
  { id: 'calc-grounds',     icon: '📐', label: '산정기준 관리',         section: null, gnb: GNB_CATE.PROGRAM },
  { id: 'form-builder',     icon: '📝', label: '교육양식마법사',         section: null, gnb: GNB_CATE.PROGRAM },
  { id: 'service-policy',   icon: '🔧', label: '서비스 정책 관리',       section: null, gnb: GNB_CATE.PROGRAM },
...
const BUDGET_ADMIN_MENUS = [
  ...
  { id: 'form-builder',        icon: '📝', label: '교육신청양식마법사',    section: null, gnb: GNB_CATE.PROGRAM },
  { id: 'service-policy',      icon: '🔧', label: '서비스 정책 관리',        section: '교육운영', gnb: GNB_CATE.PROGRAM },
  { id: 'isolation-groups',    icon: '🛡️', label: '교육지원도메인 관리',    section: null, gnb: GNB_CATE.PROGRAM },
  { id: 'plan-mgmt',           icon: '📋', label: '교육계획 관리',           section: '운영 업무', gnb: GNB_CATE.PROGRAM },
  { id: 'allocation',          icon: '💰', label: '예산 배정 및 관리',       section: null, gnb: GNB_CATE.PROGRAM },
  { id: 'my-operations',       icon: '📥', label: '나의 운영 업무',           section: null, gnb: GNB_CATE.PROGRAM },
  { id: 'reports',             icon: '📈', label: '통계 및 리포트',          section: null, gnb: GNB_CATE.STATS },
  { id: 'manual',              icon: '📖', label: '서비스 매뉴얼',           section: null, gnb: GNB_CATE.ETC },
...
const BUDGET_OP_MENUS = [
  ...
  { id: 'service-policy', icon: '🔧', label: '서비스 정책 관리',        section: '교육운영', gnb: GNB_CATE.PROGRAM },
  { id: 'my-operations',  icon: '📥', label: '나의 운영 업무',           section: null, gnb: GNB_CATE.PROGRAM },
  { id: 'org-budget',      icon: '💰', label: '조직 예산 현황',          section: null, gnb: GNB_CATE.PROGRAM },
  { id: 'reports',         icon: '📈', label: '통계 및 리포트',          section: null, gnb: GNB_CATE.STATS },
];
