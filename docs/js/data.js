...
const MOCK_HISTORY = [
  {
    id: "H001",
    tenantId: "HMC",
    title: "AWS 클라우드 아키텍처 전문가 과정",
    type: "사외교육",
    category: "edu_offline",
    date: "2026-02-10",
    endDate: "2026-02-12",
    hours: 24,
    amount: 1500000,
  ...
  },
  {
    id: "H002",
    tenantId: "HMC",
    title: "SDV 소프트웨어 개발 세미나",
    type: "세미나",
    category: "conf_present",
    date: "2026-01-20",
    endDate: "2026-01-20",
    hours: 8,
    amount: 300000,
...
const savedPersonaFo =
  sessionStorage.getItem("currentPersona") || "hmc_team_mgr";
...
let PURPOSES = [
  ...
  // misc_ops(기타운영): DB 교육지원 운영 규칙에 등록된 경우에만 자동 노출.
