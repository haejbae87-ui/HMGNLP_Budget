...
<div style="max-width:940px;margin:0 auto">
  <div style="background:linear-gradient(135deg,#002C5F,#1D4ED8);border-radius:16px;padding:28px 32px;color:#fff;margin-bottom:28px">
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:8px">
      <span style="background:rgba(255,255,255,.2);padding:3px 10px;border-radius:6px;font-size:9px;font-weight:900;letter-spacing:.1em">FRONT-OFFICE MANUAL v3.0</span>
    </div>
    ...
    <p style="font-size:13px;color:rgba(255,255,255,.8);margin:0;line-height:1.6">
      ...
      차세대학습플랫폼 기획자·개발자가 학습자 화면 흐름을 파악하는 데도 활용하세요. | 2026-03-27 v3.0
    </p>
  </div>
  ...
  const scenarios = [
    {
      ...
      steps:[
        ...
        { n:'3', t:'교육유형 선택', d:'집합·이러닝·세미나 등 학습 유형 직접 선택' },
    ...
    },
    {
      ...
      steps:[
        ...
        { n:'3', t:'교육계획 선택 (교육유형 자동 세팅)', d:'사전 승인된 R&D 교육계획 목록에서 선택. 계획에 등록된 교육유형이 자동 세팅됨. 교육유형 선택 단계 Skip.' },
  ...
  const menus = [
    ...
    },
    {
      ...
      desc:`교육 실행 전 예산 사전 계획 및 승인 프로세스입니다.<br>
             <strong>Step1.</strong> 목적 선택: 서비스 정책 기반 자동 필터<br>
             <strong>Step2.</strong> 예산 선택: 목적 연동 예산카드 자동 표시<br>
      ...
      impl:'planState 객체로 4단계 상태 관리. 내 계획·팀 계획 탭 분리(team_view_enabled).',
    },
    {
      icon:'📝', name:'교육신청',
      ...
      impl:'applyState.budgetChoice(general/rnd/none)으로 분기. 내 신청·팀 신청 탭 분리.',
    },
    {
      icon:'✅', name:'팀원용 결재함',
...
function _foManIA() {
  const screens = [
    ...
    { area:'교육계획', menu:'계획 수립 위저드', screen:'Step 1 목적 선택',                  type:'화면',     diff:'★★☆', note:'서비스 정책 기반 목적 필터' },
    { area:'교육계획', menu:'계획 수립 위저드', screen:'Step 2 예산 선택',                  type:'화면',     diff:'★★★', note:'목적 연동 예산카드 자동 필터' },
    ...
    { area:'교육신청', menu:'신청 위저드',      screen:'Step 1 목적 선택',                  type:'화면',     diff:'★★☆', note:'서비스 정책 기반' },
    { area:'교육신청', menu:'신청 위저드',      screen:'Step 2 예산·계획 선택',             type:'화면',     diff:'★★★', note:'R&D 시 계획 선택→유형 자동세팅' },
