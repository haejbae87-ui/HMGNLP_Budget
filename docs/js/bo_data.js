...
const BO_PERSONAS = {
  ...
  hmc_total_general: {
    ...
    vorgId: 'HMC-GENERAL',
    accessMenus: ['dashboard', 'isolation-groups', 'budget-account', 'virtual-org', 'form-builder', 'calc-grounds', 'service-policy', 'plan-mgmt', 'allocation', 'budget-history', 'my-operations', 'reports', 'manual']
  },
  hmc_hq_general: {
