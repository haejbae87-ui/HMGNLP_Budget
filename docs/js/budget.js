...
<div class="max-w-6xl mx-auto space-y-6">
  ...
  <div class="grid grid-cols-3 gap-4">
    ${[
      { label: '총 예산', v: fmt(totalBalance) + '원', c: 'text-brand', bg: 'bg-blue-50' },
      { label: '집행 금액', v: fmt(totalUsed) + '원', c: 'text-orange-600', bg: 'bg-orange-50' },
      { label: '잔여 예산', v: fmt(totalBalance - totalUsed) + '원', c: 'text-green-600', bg: 'bg-green-50' },
    ].map(k => `<div class="card p-6 ${k.bg} border-0">
