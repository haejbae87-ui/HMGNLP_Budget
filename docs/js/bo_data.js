...
const BO_PERSONAS = {
  ...
  hmc_tenant_admin: {
    ...
    vorgId: 'HMC-ALL',
    accessMenus: ['dashboard', 'isolation-groups', 'budget-account', 'virtual-org', 'form-builder', 'channel-mgmt', 'course-mgmt', 'session-mgmt', 'enrollment-mgmt', 'reports', 'manual']
  },
  // ── HMC 일반예산 그룹 ────────────────────────────────────────────────────────
  hmc_total_general: {
    ...
    vorgId: 'HMC-GENERAL',
    accessMenus: ['dashboard', 'isolation-groups', 'budget-account', 'virtual-org', 'form-builder', 'calc-grounds', 'service-policy', 'plan-mgmt', 'result-mgmt', 'allocation', 'budget-history', 'budget-demand', 'my-operations', 'channel-mgmt', 'course-mgmt', 'session-mgmt', 'enrollment-mgmt', 'reports', 'manual']
  },
  hmc_hq_general: {
    ...
    allowedAccounts: ['HMC-OPS', 'HMC-PART', 'HMC-ETC'],
    vorgId: 'HMC-GENERAL',
    accessMenus: ['dashboard', 'my-operations', 'org-budget', 'channel-mgmt', 'course-mgmt', 'session-mgmt', 'enrollment-mgmt', 'reports', 'manual']
  },
  // ── HMC R&D예산 그룹 ────────────────────────────────────────────────────────
  hmc_total_rnd: {
  ...
  hsc_budget_gen: {
    ...
    accessMenus: ['dashboard', 'budget-account', 'virtual-org', 'plan-mgmt', 'result-mgmt', 'allocation', 'budget-history', 'budget-demand', 'my-operations', 'channel-mgmt', 'course-mgmt', 'session-mgmt', 'enrollment-mgmt', 'reports', 'manual']
  },
  hsc_total: {
  ...
  hsc_budget_rnd: {
    ...
    ownedAccounts: ['HSC-OPS', 'HSC-PART'],
    allowedAccounts: ['HSC-OPS', 'HSC-PART'],
    accessMenus: ['dashboard', 'budget-account', 'virtual-org', 'plan-mgmt', 'allocation', 'budget-history', 'budget-demand', 'my-operations', 'channel-mgmt', 'course-mgmt', 'session-mgmt', 'enrollment-mgmt', 'reports', 'manual']
  },
  hsc_budget_hr_dang: {
  ...
  hmc_team_mgr: {
    ...
    vorgId: 'HMC-GENERAL',
    scope: '역량혁신팀',
    accessMenus: ['dashboard', 'plan-mgmt', 'allocation', 'budget-history']
  },
  hmc_learner: {
